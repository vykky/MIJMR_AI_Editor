...
# 2. API Key Setup (Sidebar)
st.sidebar.header("⚙️ Configuration")
api_key = st.sidebar.text_input("Enter your Gemini API Key", type="password")
st.sidebar.info("This API key is secure and will not be saved anywhere.")
...
def analyze_paper_with_gemini(text, api_key):
    ...
    # Using the latest advanced flash model
    ...
    try:
        ...
        return f"API Error: {e}\n(Please wait a few seconds and try again, or check your API Key / Budget limits)."
        ...
        if not api_key:
            ...
            with st.spinner("⏳ AI is reading the paper... Please wait..."):
                ...
                if "Error extracting text" in paper_text:
                    ...
                    time.sleep(2) # Small delay to prevent rate limit shocks
